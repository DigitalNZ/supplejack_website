...
export default class Panel extends Component {
  ...
  render() {
    ...
    const usageDescription = 'Before copying or reusing any item founds on DigitalNZ, you need to check the terms of use and/or copyright on the item’s web page.';
    ...
    return (
      <div id="search_filter" className="filter-container menu content">
        ...
        <div className="tabs-content">
          {currentTabComponent}
          { (currentTab.props.facet === 'usage') && <div className="tabs-description">  {usageDescription}  </div>}
        </div>
      </div>
    );
  }
